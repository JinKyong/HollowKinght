...
HRESULT EF_Slash2::init(POINT position, float angle, float speed, float damage)
{
	_img = new image;
	_img->init("image/effect/slash2.bmp", 360, 166, 2, 2, true, RGB(255, 0, 255));
...
void EF_Slash2::release()
{
	_img->release();
	SAFE_DELETE(_img);
}

void EF_Slash2::update()
{
	//move
